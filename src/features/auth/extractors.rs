...
use super::{jwt, models::AuthUser};
use crate::{features::users::models::User, state::AppState};
...
impl FromRequestParts<Arc<AppState>> for AuthUser {
    ...
    async fn from_request_parts(
        ...
        let user = sqlx::query_as!(User, "SELECT * FROM gossip_user WHERE id = $1", user_id)
